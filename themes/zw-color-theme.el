  ...
  (color-theme-install
   '(color-theme-zwtm
     ((background-color . "#1E1E1E")
      ...
      (mouse-color . "sienna1"))
     (default ((t (:background "#1E1E1E" :foreground "#F8F8F8"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "#1E1E1E" :foreground "#F8F8F8"))))
     (font-lock-builtin-face ((t (:foreground "#F8F8F8"))))
     (font-lock-comment-face ((t (:italic t :foreground "#AEAEAE"))))
     (font-lock-constant-face ((t (:foreground "#D8FA3C"))))
     (font-lock-doc-string-face ((t (:foreground "DarkOrange"))))
     (font-lock-function-name-face ((t (:foreground "#AB8222"))))
     (font-lock-keyword-face ((t (:foreground "#FAEFAC"))))
     ...
     (font-lock-string-face ((t (:foreground "#A0AB7F")))) ;;#61CE3C
     (font-lock-type-face ((t (:foreground "#8DA6CE"))))
     (font-lock-variable-name-face ((t (:foreground "#CFBB8B"))))

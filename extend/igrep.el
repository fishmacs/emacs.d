...
;;; Copyright:
;;;
;;; Copyright © 1994,1995,1996,1997,1998 Kevin Rodgers
;;;
...
(eval-when-compile
  ...
  (require 'ange-ftp)			; ange-ftp-ftp-name
;;;  (require 'efs)			; efs-ftp-path
  )

(defconst igrep-version "2.82"
  "Version of igrep.el")
